...
const Layout = ({ children }: { children: React.ReactNode }) => {
    ...
    const navSections = [
        {
            ...
            items: [
                ...
                { icon: Kanban, label: 'Job Pipeline', path: '/pipeline', roles: ['Admin', 'Manager', 'Coordinator'] },
            ]
        },
        {
        ...
        },
        {
            title: 'CRM',
            items: [
                { icon: LayoutDashboard, label: 'Dashboard', path: '/crm/dashboard', roles: ['Admin', 'Sales Executive', 'Manager', 'Coordinator'] },
            ]
        },
        {
            title: 'Financial',
    ...
    const mobileNavItems = [
        ...
        { icon: UserPlus, label: 'CRM', path: '/crm/dashboard', roles: ['Admin', 'Sales Executive', 'Manager', 'Coordinator'] },
        { icon: MapPin, label: 'Surveys', path: '/surveys', roles: ['Admin', 'Surveyor'] },
        { icon: GitMerge, label: 'Leads', path: '/leads', roles: ['Admin', 'Sales Executive', 'Manager', 'Coordinator'] },
